...
public class TestTrialOWLRules extends TestCase {
    ...
    static {
        ...
        configuration.addProperty(ReasonerVocabulary.PROPruleSet, "etc/owl-fb.rules");
...
//        OWLWGTester tester = new OWLWGTester(OWLExptRuleReasonerFactory.theInstance(), this, null);
    ...
    public static void main(String[] args) {
        Model premises = FileManager.get().loadModel("testing/wg/someValuesFrom/premises001.rdf");
