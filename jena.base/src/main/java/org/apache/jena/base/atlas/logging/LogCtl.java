...
package org.apache.jena.base.atlas.logging;
...
public class LogCtl {
    ...
    @Deprecated
    static public void logLevel(String logger, java.util.logging.Level level2) {
        if ( level2 != null )
...
//          ,"log4j.appender.jena.plain.layout.ConversionPattern=%m%n"
          ...
          , "## Parser output"
          , "log4j.additivity.org.apache.jena.arq.riot=false"
          , "log4j.logger.org.apache.jena.arq.riot=INFO, jena.plainlevel"
         ) ;
    /**
     * Set logging
     * <ol>
    ...
    private static String defaultProperties = StrUtils.strjoinNL
        ("handlers=org.apache.jena.base.atlas.logging.java.ConsoleHandlerStream"
        // These are the defaults.
        //,"org.apache.jena.base.atlas.logging.java.ConsoleHandlerStream.level=INFO"
        //,"org.apache.jena.base.atlas.logging.java.ConsoleHandlerStream.formatter=org.apache.jena.base.atlas.logging.java.TextFormatter"
        //,"org.apache.jena.base.atlas.logging.java.TextFormatter.format=%5$tT %3$-5s %2$-20s :: %6$s"
        ) ;
