...
public class TestPipedRDFIterators {
        ...
        Runnable genTriples = new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 1; i <= generateSize; i++) {
                    Triple t = new Triple(
                            org.apache.jena.core.graph.NodeFactory.createBlankNode(),
                            org.apache.jena.core.graph.NodeFactory.createURI("http://predicate"), NodeFactoryExtra.intToNode(i));
                    out.triple(t);
                }
                out.finish();
                return;
    ...
    private void test_streamed_quads(int bufferSize, final int generateSize, boolean fair) throws InterruptedException,
        ...
        Runnable genQuads = new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 1; i <= generateSize; i++) {
                    Quad q = new Quad(
                            org.apache.jena.core.graph.NodeFactory.createURI("http://graph"),
                            org.apache.jena.core.graph.NodeFactory.createBlankNode(),
                            org.apache.jena.core.graph.NodeFactory.createURI("http://predicate"), NodeFactoryExtra.intToNode(i));
                    out.quad(q);
                }
    ...
    public void streamed_state_bad_02() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                out.start();
                out.triple(Triple.create(
                        org.apache.jena.core.graph.NodeFactory.createURI("urn:s"),
                        org.apache.jena.core.graph.NodeFactory.createURI("urn:p"),
                        org.apache.jena.core.graph.NodeFactory.createURI("urn:o")));
                out.finish() ;
