...
import org.apache.jena.arq.riot.stream.TestLocationMapper ;
...
public class TestFileManager extends BaseTest
{
    ...
    public void testFileManagerNoFile3() {
        FileManager fileManager = new AdapterFileManager(new StreamManager(), new org.apache.jena.arq.riot.system.stream.LocationMapper()) ;
        fileManager.addLocatorFile() ;
        fileManager.readModel(ModelFactory.createDefaultModel(), filenameNonExistent);
    }
