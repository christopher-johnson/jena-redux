...
package org.apache.jena.arq.sparql.syntax;
...
import org.apache.jena.arq.sparql.sse.Item ;
import org.apache.jena.arq.sparql.sse.ItemException ;
...
public class TestSSE_Basic extends TestCase
{
    ...
    static Node int1 = org.apache.jena.core.graph.NodeFactory.createLiteral("1", XSDDatatype.XSDinteger) ;
    static Node int2 = org.apache.jena.core.graph.NodeFactory.createLiteral("2", XSDDatatype.XSDinteger) ;
    static Node int3 = org.apache.jena.core.graph.NodeFactory.createLiteral("3", XSDDatatype.XSDinteger) ;
    static Node strLangEN = org.apache.jena.core.graph.NodeFactory.createLiteral("xyz", "en") ;
...
//    }
    ...
    { 
        Node n = org.apache.jena.core.graph.NodeFactory.createLiteral("A\tB") ;
        testNode("'''A\\tB'''", n) ;
    }
    ...
    @Test public void testNode_2()    { testNode("<http://example/node1>", org.apache.jena.core.graph.NodeFactory.createURI("http://example/node1")) ; }
