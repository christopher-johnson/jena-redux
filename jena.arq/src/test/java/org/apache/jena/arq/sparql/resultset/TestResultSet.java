...
package org.apache.jena.arq.sparql.resultset;
...
import org.apache.jena.arq.riot.resultset.ResultSetLang;
import org.apache.jena.arq.riot.resultset.rw.ResultsReader;
import org.apache.jena.arq.riot.resultset.rw.ResultsWriter;
import org.apache.jena.arq.sparql.core.Var ;
import org.apache.jena.arq.sparql.engine.QueryIterator ;
import org.apache.jena.arq.sparql.engine.ResultSetStream ;
import org.apache.jena.arq.sparql.engine.binding.Binding ;
import org.apache.jena.arq.sparql.engine.binding.BindingFactory ;
import org.apache.jena.arq.sparql.engine.binding.BindingMap ;
import org.apache.jena.arq.sparql.engine.iterator.QueryIterPlainWrapper ;
import org.apache.jena.arq.sparql.engine.iterator.QueryIterSingleton ;
import org.apache.jena.arq.sparql.sse.SSE ;
import org.apache.jena.arq.sparql.sse.builders.BuilderResultSet ;
import org.apache.jena.arq.sparql.util.Context;
import org.apache.jena.arq.sparql.util.NodeFactoryExtra ;
import org.apache.jena.arq.sparql.util.ResultSetUtils ;
...
public class TestResultSet extends BaseTest
{
    ...
    {
        ResultSetRewindable rs1 = makeRewindable("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
        ByteArrayOutputStream arr = new ByteArrayOutputStream() ;
        ResultSetFormatter.outputAsXML(arr, rs1) ;
        rs1.reset() ;
        ByteArrayInputStream ins = new ByteArrayInputStream(arr.toByteArray()) ;
    ...
    {
        ResultSetRewindable rs1 = make2Rewindable("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
        ByteArrayOutputStream arr = new ByteArrayOutputStream() ;
        ResultSetFormatter.outputAsJSON(arr, rs1) ;
        rs1.reset() ;
        ByteArrayInputStream ins = new ByteArrayInputStream(arr.toByteArray()) ;
    ...
    {
    	ResultSet rs1 = make("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
    	ResultSet rs2 = make("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
    	ResultSet rs3 = make2("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
    ...
    {
    	ResultSet rs1 = make("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
    	ResultSet rs2 = make("y", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
    ...
    @Test public void test_RS_cmp_5()
    {
        ...
        ResultSetRewindable rs1 = makeRewindable("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local:1")) ;
        ResultSetRewindable rs2 = makeRewindable("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local:2")) ;
        assertFalse(ResultSetCompare.equalsByTerm(rs1, rs2)) ;
        rs1.reset() ;
        rs2.reset() ;
        assertFalse(ResultSetCompare.equalsByTerm(rs1, rs2)) ;
    ...
    @Test public void test_RS_cmp_6()
    {
        ...
        ResultSetRewindable rs1 = makeRewindable("x", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
        ResultSetRewindable rs2 = makeRewindable("y", org.apache.jena.core.graph.NodeFactory.createURI("tag:local")) ;
