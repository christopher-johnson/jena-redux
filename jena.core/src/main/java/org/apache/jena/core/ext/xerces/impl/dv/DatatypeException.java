...
package org.apache.jena.core.ext.xerces.impl.dv;
...
public class DatatypeException extends Exception {
    ...
    public String getMessage() {
        ...
        resourceBundle = ResourceBundle.getBundle("org.apache.jena.core.ext.xerces.impl.msg.XMLSchemaMessages");
        if (resourceBundle == null)
            throw new MissingResourceException("Property file not found!", "org.apache.jena.core.ext.xerces.impl.msg.XMLSchemaMessages", key);

        String msg = resourceBundle.getString(key);
        if (msg == null) {
            msg = resourceBundle.getString("BadMessageKey");
            throw new MissingResourceException(msg, "org.apache.jena.core.ext.xerces.impl.msg.XMLSchemaMessages", key);
        }
