...
import org.apache.jena.arq.sparql.lang.arq.ARQParser ;
...
public class ParserARQ extends SPARQLParser
{
    ...
    private static void perform(Query query, String string, Action action)
    {
        ...
        catch (org.apache.jena.arq.sparql.lang.arq.ParseException ex)
        { 
            throw new QueryParseException(ex.getMessage(),
                                          ex.currentToken.beginLine,
                                          ex.currentToken.beginColumn
                                          ) ; }
        catch (org.apache.jena.arq.sparql.lang.arq.TokenMgrError tErr)
        {
