...
//        Node gn = org.apache.jena.core.graph.NodeFactory.createURI(graphName) ;
//
//        TL.exec((ds) -> {
//            // ?? See TupleLib.
...
//        Triple triple = SSE.parseTriple("(<x> <y> <z>)") ;
//        TL.exec((ds) -> {
//            Graph g2 = ds.asDatasetGraph().getGraph(org.apache.jena.core.graph.NodeFactory.createURI(graphName)) ;
//            // Graphs only exists if they have a triple in them
//            g2.add(triple) ;
//
