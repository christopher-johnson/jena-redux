...
import org.apache.jena.core.rdfxml.xmlinput.StAX2Model ;
...
public class StAX2ModelTest extends TestCase {
    ...
    static public TestSuite suite() {
        TestSuite s = new TestSuite("StAX2Model");
        
        // Note step size here. Full test is a bit lengthy.
        for (int i = 0; i < all.length; i += 25) {
            if (all[i].startsWith("wg/")) {
                ...
                addTests(s, "arp/", ARPTests.arpTestDir.toString(), all[i].substring(4));
            } else {
    ...
    StAX2ModelTest(String dir, String base0, String file) {
        super(file);
