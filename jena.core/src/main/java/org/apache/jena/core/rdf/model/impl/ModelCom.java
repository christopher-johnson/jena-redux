...
import org.apache.jena.core.enhanced.BuiltinPersonalities ;
import org.apache.jena.core.enhanced.EnhGraph ;
import org.apache.jena.core.enhanced.Personality ;
import org.apache.jena.core.graph.* ;
import org.apache.jena.core.graph.impl.LiteralLabel ;
import org.apache.jena.core.graph.impl.LiteralLabelFactory ;
import org.apache.jena.core.rdf.model.* ;
import org.apache.jena.core.shared.* ;
...
implements Model, PrefixMapping, Lock
{
    ...
    /** @deprecated Use {@code org.apache.jena.arq.riot.RDFParserRegistry.register}
     */
    @Override
    @Deprecated
    ...
    /** @deprecated Use {@code org.apache.jena.arq.riot.RDFWriterRegistry.register}
     */
    @Override
    @Deprecated
      ...
      */
      ...
      { return new StmtIteratorImpl( new Map1Iterator<>( t -> asStatement( t ), it ) ); }
        ...
        models.
     	...
     	@see org.apache.jena.core.rdf.model.Model#intersection(org.apache.jena.core.rdf.model.Model)
           */
          @Override
