...
public class ARQConstants
{
    ...
    public static final String ARQFunctionLibrary = javaClassURIScheme+"org.apache.jena.arq.sparql.function.library." ;
    
    /** The ARQ property function library */
    public static final String ARQPropertyFunctionLibrary = javaClassURIScheme+"org.apache.jena.arq.sparql.pfunction.library." ;

    /** The ARQ property function library */
    public static final String ARQProcedureLibrary = javaClassURIScheme+"org.apache.jena.arq.sparql.procedure.library." ;
