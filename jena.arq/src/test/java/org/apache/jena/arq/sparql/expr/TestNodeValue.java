...
//                     actualStr);
    ...
    public void testLang1() {
        Node n1 = org.apache.jena.core.graph.NodeFactory.createLiteral("xyz", "en");
        NodeValue nv1 = NodeValue.makeNode(n1);
        Node n2 = org.apache.jena.core.graph.NodeFactory.createLiteral("xyz", "en");
    ...
    public void testEquals4() {
        NodeValue nv1 = NodeValue.makeNode(org.apache.jena.core.graph.NodeFactory.createURI("http://example"));
        NodeValue nv2 = NodeValue.makeNode(org.apache.jena.core.graph.NodeFactory.createURI("http://example"));
        assertEquals("Not NodeValue.equals()", nv1, nv2);
    }
    ...
    public void testNotEquals3() { // Literals and URIs are different.
        NodeValue nv1 = NodeValue.makeNode(org.apache.jena.core.graph.NodeFactory.createURI("http://example"));
        NodeValue nv2 = NodeValue.makeNode(org.apache.jena.core.graph.NodeFactory.createLiteral("http://example"));
        assertFalse("NodeValue.equals()", nv1.equals(nv2));
    }
}
