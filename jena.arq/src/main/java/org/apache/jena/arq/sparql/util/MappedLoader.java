...
import org.apache.jena.arq.sparql.function.library.leviathan.LeviathanConstants ;
...
public class MappedLoader {
    ...
    static {
        ...
        // Old name, new name
        uriMap.put("java:com.hp.hpl.jena.query.function.library.",  "java:org.apache.jena.arq.sparql.function.library.");
        uriMap.put("java:com.hp.hpl.jena.query.pfunction.library.", "java:org.apache.jena.arq.sparql.pfunction.library.");
