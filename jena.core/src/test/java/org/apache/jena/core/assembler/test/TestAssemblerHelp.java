...
package org.apache.jena.core.assembler.test;

import java.util.*;

import org.apache.jena.core.assembler.* ;
import org.apache.jena.core.assembler.assemblers.* ;
import org.apache.jena.core.assembler.exceptions.* ;
...
public class TestAssemblerHelp extends AssemblerTestBase
    ...
    static Model gremlinModel = modelWithStatements( "eh:Wossname ja:assembler 'org.apache.jena.core.assembler.test.TestAssemblerHelp$Gremlin'" );
    ...
    public void testClassAssociation()
        {
        String className = "org.apache.jena.core.assembler.test.TestAssemblerHelp$Imp";
    ...
    public void testClassResourceConstructor()
        {
        AssemblerGroup group = AssemblerGroup.create();
        Model m = model( "eh:Wossname ja:assembler 'org.apache.jena.core.assembler.test.TestAssemblerHelp$Gremlin'" );
