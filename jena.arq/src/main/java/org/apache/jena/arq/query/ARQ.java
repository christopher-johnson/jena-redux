...
import org.apache.jena.arq.sparql.algebra.optimize.TransformOrderByDistinctApplication ;
import org.apache.jena.arq.sparql.core.assembler.AssemblerUtils ;
import org.apache.jena.arq.sparql.engine.http.Service ;
import org.apache.jena.arq.sparql.expr.aggregate.AggregateRegistry ;
import org.apache.jena.arq.sparql.function.FunctionRegistry ;
import org.apache.jena.arq.sparql.lib.Metadata ;
import org.apache.jena.arq.sparql.mgt.ARQMgt ;
import org.apache.jena.arq.sparql.mgt.Explain ;
import org.apache.jena.arq.sparql.mgt.Explain.InfoLevel ;
import org.apache.jena.arq.sparql.mgt.SystemInfo ;
import org.apache.jena.arq.sparql.pfunction.PropertyFunctionRegistry ;
import org.apache.jena.arq.sparql.util.Context ;
import org.apache.jena.arq.sparql.util.MappingRegistry ;
...
public class ARQ
{
     ...
     * e.g. log4j.properties -- log4j.logger.org.apache.jena.arq.sparql.exec=INFO
...
//    public static final Symbol enableRomanNumerals = ARQConstants.allocSymbol("romanNumerals") ;
     ...
     * 
     * @see org.apache.jena.arq.sparql.engine.http.Service
     */
