...
import static org.apache.jena.core.datatypes.xsd.XSDDatatype.* ;
import static org.apache.jena.arq.sparql.expr.ValueSpaceClassification.* ;
...
import org.apache.jena.base.atlas.lib.DateTimeUtils ;
import org.apache.jena.base.atlas.lib.StrUtils ;
import org.apache.jena.base.atlas.logging.Log ;
import org.apache.jena.core.datatypes.DatatypeFormatException ;
import org.apache.jena.core.datatypes.RDFDatatype ;
import org.apache.jena.core.datatypes.TypeMapper ;
import org.apache.jena.core.datatypes.xsd.XSDDateTime ;
import org.apache.jena.core.ext.xerces.DatatypeFactoryInst;
import org.apache.jena.core.graph.Node ;
import org.apache.jena.core.graph.NodeFactory ;
import org.apache.jena.core.graph.impl.LiteralLabel ;
...
import org.apache.jena.arq.sparql.function.FunctionEnv ;
...
import org.apache.jena.arq.sparql.util.* ;
...
//    }
    ...
    public static NodeValue makeDateTime(XMLGregorianCalendar cal)
    {
        ...
        Node node = org.apache.jena.core.graph.NodeFactory.createLiteral(lex, XSDdateTime) ;
    ...
    {
        String lex = cal.toXMLFormat() ;
        Node node = org.apache.jena.core.graph.NodeFactory.createLiteral(lex, XSDdate) ;
        return new NodeValueDT(lex, node) ;
    }
