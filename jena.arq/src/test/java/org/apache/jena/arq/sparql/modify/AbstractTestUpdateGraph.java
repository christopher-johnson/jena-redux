...
import org.apache.jena.arq.update.UpdateAction ;
import org.apache.jena.arq.update.UpdateExecutionFactory ;
import org.apache.jena.arq.update.UpdateProcessor ;
...
public abstract class AbstractTestUpdateGraph extends AbstractTestUpdateBase
{
    ...
    @Test public void testModify2()
    {
        ...
        Triple t =  new Triple(org.apache.jena.core.graph.NodeFactory.createBlankNode(),p,o2);
    ...
    @Test public void testCopy()
    {
        // Use blank nodes (will expose any problems in serialization when spill occurs)
        Triple t =  new Triple(org.apache.jena.core.graph.NodeFactory.createBlankNode(),p,o2);
        Triple t2 = new Triple(org.apache.jena.core.graph.NodeFactory.createBlankNode(),p,o1);
    ...
    @Test public void testUpdateScript2()
    {
        ...
        assertTrue(graphContains(gStore.getGraph(org.apache.jena.core.graph.NodeFactory.createURI("http://example/g1")),
    ...
    @Test public void testUpdateScript3()
    {
        ...
        assertTrue(graphEmpty(gStore.getGraph(org.apache.jena.core.graph.NodeFactory.createURI("http://example/g1")))) ;
        assertTrue(graphEmpty(gStore.getDefaultGraph())) ;
    }
    ...
    @Test public void testUpdateScript5()
    {
        ...
        Node b = org.apache.jena.core.graph.NodeFactory.createBlankNode() ;
