...
import org.apache.jena.arq.sparql.lang.sparql_10.SPARQLParser10 ;
...
public class ParserSPARQL10 extends SPARQLParser
{
    ...
    private static void perform(Query query, String string, Action action)
    {
        ...
        catch (org.apache.jena.arq.sparql.lang.sparql_10.ParseException ex)
        { 
            throw new QueryParseException(ex.getMessage(),
                                          ex.currentToken.beginLine,
                                          ex.currentToken.beginColumn
                                          ) ; }
        catch (org.apache.jena.arq.sparql.lang.sparql_10.TokenMgrError tErr)
        {
