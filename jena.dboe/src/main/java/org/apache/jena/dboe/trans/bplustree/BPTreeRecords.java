...
public final class BPTreeRecords extends BPTreePage {
    ...
    private BPTreeRecords insertNewPage() {
        ...
        BPTreeRecords other = create(NO_ID) ;
        rBuffPage.setLink(NO_ID) ;
        return other ;
    }
    ...
    public String toString() {
        return format("BPTreeRecords[id=%d, link=%d]: %s", getId(), getLink(), rBuff.toString()) ;
    }
    ...
    public String getRefStr() {
        return format("BPTRecord[id=%d]", getBackingBlock().getId()) ;
    }
