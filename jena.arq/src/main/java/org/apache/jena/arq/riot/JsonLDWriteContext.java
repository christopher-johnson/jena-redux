...
import org.apache.jena.arq.riot.writer.JsonLDWriter;
 ...
 * last argument to  {@link org.apache.jena.arq.riot.WriterDatasetRIOT#write(OutputStream, DatasetGraph, PrefixMap, String, Context)}
 * when the WriterDatasetRIOT has been created with one of the JSON-LD RDFFormat variants (that is, when it is
 * an instance of {@link org.apache.jena.arq.riot.writer.JsonLDWriter})
 * 
