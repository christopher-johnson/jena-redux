...
import org.apache.jena.base.atlas.lib.Bytes;
...
public class TestBPlusTreeRewriterNonTxn extends Assert
{
    ...
    static boolean b ; 
    @BeforeClass
    public static void beforeClass()   { b = BlockMgrFactory.AddTracker ; BlockMgrFactory.AddTracker = false ; }
    @AfterClass
    public static void afterClass()    { BlockMgrFactory.AddTracker = b  ;}
    
    @Test
    public void bpt_rewrite_01()  { runTest(2, 0) ; }
    @Test
    public void bpt_rewrite_02()  { runTest(3, 0) ; }

    @Test
    public void bpt_rewrite_03()  { runTest(2, 1) ; }
    @Test
    public void bpt_rewrite_04()  { runTest(3, 1) ; }

    @Test
    public void bpt_rewrite_05()  { runTest(2, 2) ; }
    @Test
    public void bpt_rewrite_06()  { runTest(3, 2) ; }
    
    @Test
    public void bpt_rewrite_07()  { runTest(2, 100) ; }
    @Test
    public void bpt_rewrite_08()  { runTest(3, 100) ; }
    
    @Test
    public void bpt_rewrite_99()  { runTest(5, 1000) ; }
    ...
    public static void runOneTest(int order, int N, RecordFactory recordFactory, boolean debug)
    {
        ...
        // ---- Test data
        List<Record> originaldata = org.apache.jena.dboe.trans.bplustree.TestBPlusTreeRewriterNonTxn.createData(N, recordFactory) ;
        if ( debug )
